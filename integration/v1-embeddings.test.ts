...
// default local address, started with both `--embedding` and a pooling type
// other than `none` (e.g. `--embedding --pooling mean`); see the server
// requirements in specs/endpoints/v1-embeddings.md.
