...
- Added `examples/v1-embeddings.ts` demonstrating a single-input call and a
  batch (array `input`) call, reading `baseUrl`/`apiKey` from the
  ...
  requirement (`--embedding --pooling mean`), sourced from the spec's "Server
...
## T-071: Tests for /v1/chat/completions tool calling
...
## T-072: Example for /v1/chat/completions tool calling
...
## T-074: Tests for streaming tool calls on /v1/chat/completions
...
## T-078: Tests for multimodal content parts on /v1/chat/completions
...
## T-079: Example for multimodal content on /v1/chat/completions
...
## T-082: Tests for multimodal input on /completion
...
## T-083: Example for multimodal input on /completion
...
## T-092: Tests for multimodal input on /completion
...
## T-096: Example for multimodal input on /embedding
